...
export class CustometAddressController {
  constructor(private readonly custometAddressService: CustometAddressService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCustometAddressDto: UpdateCustometAddressDto) {
